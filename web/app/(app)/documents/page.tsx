...
export default async function DocumentsPage() {
  ...
  return (
    <>
      <PageHeader
        title="CVs & Documents"
        description="Tailored CVs and cover letters from the Tracker are rendered to PDF (headless Chromium) and stored here. Older Markdown-only runs may appear under drafts. Your master résumé is in the cv.md tab."
      />
        ...
        <Tabs defaultValue="generated" className="gap-6">
          ...
          <TabsContent value="generated" className="flex flex-col gap-6">
            ...
            <DocSection
              ...
              icon={Mail}
              files={cls}
              empty="No cover letter PDFs yet — generate from the Tracker when that flow writes binary PDFs."
            />
            <DocSection
